        ...
        <View style={styles.section}>
          ...
          <View style={styles.statsGrid}>
            <TouchableOpacity style={styles.statCard}>
              ...
              <Text style={styles.statValor}>{calcularDiasActivo()}</Text>
            ...
            <TouchableOpacity style={styles.statCard}>
              ...
              <Text style={styles.statValor}>
                {calcularPromedioTiempoPorEntrenamiento()}
              </Text>
              <Text style={styles.statLabel}>Min/entrenamiento</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.statCard}>
              ...
              <Text style={styles.statValor}>
                {Math.floor(
                  (userData?.estadisticas?.tiempoTotalEntrenado || 0) / 60
                )}
                h
              </Text>
